    ...
    .then(data => {
        ...
        for (let num = 0; num < infos.length; num++) {
            ...
            if (info.payLaterRate) {
                ...
                const payLater = info.payLaterRate;
                console.log("payLater >>> ", payLater);
                // payLaterAmount = payLater.amount;
                // console.log("payLaterAmount >>> ", payLaterAmount);
                // payLaterTotalAmount = payLater.totalRateAmount;
                // csvRow[num] = {'Name': carName, 'Type': carDesc, 'PayLater': payLaterAmount, 'PayLaterTotal': payLaterTotalAmount}
